...
<body>
    ...
    <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif; ">
        <div class="row">
            <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                <img src="{{ asset('images/hms.jpg') }}" alt="" width="10%" height="80%" />
                <h3>Welcome</h3>
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('patient_login') }}">Already have an account?</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="tel" minlength="11" maxlength="11" name="contact"
    ...
    <form method="post" action="{{ route('doctor.login.post') }}">
        ...
        <div class="row register-form">
            <div class="col-md-6">
                <div class="form-group">
                    <input type="number" class="form-control" placeholder="Doctor ID *"
                        name="id" required />
                </div>
            </div>
            <div class="col-md-6">
